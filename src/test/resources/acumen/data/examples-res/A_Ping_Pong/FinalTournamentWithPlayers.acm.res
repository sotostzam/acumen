...
#0.1 {
  _3D = [["Text", [-2.800000, 6.500000, -4], 1, [0.900000, 0, 0], [1.700000, 0, 0], "WiffWaff"], ["Text", [2.800000, 6.500000, -4], 1, [0.100000, 0.100000, 0.100000], [1.700000, 0, 0], "ParadoX"], ["Text", [-1.500000, 6.500000, -5], 1, [0.600000, 0, 0], [1.700000, 0, 0], 0], ["Text", [4.500000, 6.500000, -5], 1, [0.100000, 0.100000, 0.100000], [1.700000, 0, 0], 0]],
  ball = #0.1.0,
  ballActuator = #0.1.2,
  ballob = #0.1.1,
  bat1 = #0.1.7,
...
#0.2 {
  _3D = [["Text", [-2.800000, 6.500000, -4], 1, [0.900000, 0, 0], [1.700000, 0, 0], "ParadoX"], ["Text", [2.800000, 6.500000, -4], 1, [0.100000, 0.100000, 0.100000], [1.700000, 0, 0], "WiffWaff"], ["Text", [-1.500000, 6.500000, -5], 1, [0.600000, 0, 0], [1.700000, 0, 0], 16], ["Text", [4.500000, 6.500000, -5], 1, [0.100000, 0.100000, 0.100000], [1.700000, 0, 0], 0]],
  ball = #0.2.0,
  ballActuator = #0.2.2,
  ballob = #0.2.1,
  bat1 = #0.2.7,
...
#0.2.2 {
  action = 0,
  angle = [-0.533360, -0.179920, -0.761257],
  className = BallActuator,
  done = false,
  mode = "Initialize",
  v1 = [-1.104385, -0.372560, -0.906834],
  v2 = [2.465734, 0.831762, 4.188747],
  v3 = [-5.109545, -0.374301, 6.296153]
}
#0.2.3 {
  angle = [0.001848, 0.000000, 0.000000],
  className = BatActuator,
  energy = 17.186155,
  energy' = 0.000000,
  p = [-1.600000, -0.000000, 0.200000],
...
#0.2.7 {
  _3D = ["Cylinder", [-1.650000, -0.000000, 0.200000], [0.150000, 0.001000], [1, 0.100000, 0.100000], [-0.000000, -0.000000, -1.570000]],
  angle = [0.001848, 0.000000, 0.000000],
  className = Bat,
  ...
  n = 1,
  p = [-1.600000, -0.000000, 0.200000],
  p' = [-5.109545, -0.374301, 6.296153],
  p1 = [-1.600000, 0, 0.200000]
}
#0.2.8 {
  _3D = ["Box", [1.550000, 0.000000, 0.200000], [0.300000, 0.300000, 0.300000], [1, 1, 0.100000], [-0.000000, 1.166498, -1.905737]],
  angle = [0.010000, 0, 0],
  className = Bat,
  displayAngle = [0.000000, -1.166498, 1.905737],
  mode = "Rest",
  n = 2,
  p = [1.600000, 0.000000, 0.200000],
  p' = [0, 0, 0],
...
#0.2.11 {
  ...
  batAngle = [0.001830, 0.000000, 0.000000],
  batAngle' = [-0.001848, 0.000000, 0.000000],
  batp = [-1.600000, -0.000000, 0.200000],
  bounced = false,
  className = ParadoX,
  count = 0,
  ...
  t' = 1,
  v = [0.000000, 0.000000, 0.000000],
  v2 = [2.639824, 0.080883, 4.085320],
  v21 = [-1.874685, -0.227592, -2.399855],
  z = -7.010542
}
#0.2.12 {
  a = [0.000000, 69.936898, -19.465423],
  aTemp = [2736.833314, 69.936898, -48.663558],
  ballp = [3.030594, 0.606119, 0.032702],
  ballv = [0.000000, 0.000000, 0.000000],
  batAngle = [0.010000, 0, 0],
  batAngle' = [-0.136277, -0.045950, 0.159650],
  batp = [1.600000, 0.000000, 0.200000],
  bounced = true,
  className = WiffWaff,
  count = 0,
  desiredBatP = [45.178030, 23.403606, 0.061078],
  desiredBatP' = [42.917830, 18.183566, -5.018947],
  estimatedBatV = [0.000000, 103.517043, -2.004568],
  estimatedBatV' = [0.000000, 69.936898, -19.465423],
  hit = false,
  mode = "Prepare",
  n = 2,
  n1 = 2.623869,
  ...
  t = 41.000000,
  t' = 1,
  v = [42.917830, 18.183566, -5.018947],
  v2 = [-2.169857, -0.732026, 4.066712],
  v21 = [1.664104, 0.561102, -1.949515],
  z = -0.117092
}
------------------------------16199
