...
------------------------------6
#0 {
  _3D = [["Text", [-2, 0, -1], 1, [1, 0, 0], [1.570000, 0, 0], 16], ["Text", [1, 0, -1], 1, [0, 0, 1], [1.570000, 0, 0], 0]],
  className = Main,
  game = #0.1,
  mode = "Persist",
  score1 = 16,
...
#0.1.0 {
  _3D = ["Sphere", [1.295919, 0.259184, 0.405979], 0.030000, [1, 1, 1], [0, 0, 0]],
  className = Ball,
  k2 = 0.166667,
  k_z = [1, 1, -0.990000],
  mode = "Fly",
  p = [1.333548, 0.266710, 0.425419],
  p' = [3.762903, 0.752581, 1.944031],
  p'' = [-2.766404, -0.553281, -11.301257]
}
#0.1.1 {
  ap = [1.295000, 0.255000, 0.405000],
  className = BallObserver,
  mode = "Estimate0",
  p = [1.295919, 0.259184, 0.405979],
  pp = [1.255000, 0.250000, 0.385000],
  t = 0.010000,
  t' = 1,
  v = [3.500000, 0.500000, 2.000000]
}
#0.1.2 {
  action = 0,
  angle = [-0.843585, 0.105145, -0.526602],
  className = BallActuator,
  done = false,
  mode = "Initialize",
  v1 = [-1.217486, 0.157769, 2.455185],
  v2 = [2.052570, -0.249814, 4.496493],
  v3 = [-5.000000, 0.500000, 12.263445]
}
#0.1.3 {
  angle = [0.007397, 0.000000, 0.000000],
  className = BatActuator,
  energy = 16.591323,
  energy' = 0.000000,
  p = [-1.600000, -0.000000, 0.200000],
...
#0.1.4 {
  ...
  p = [1.600000, 0.000000, 0.200000],
  p' = [0, 0, 0],
  p'' = [-6.641716, -4.380623, 6.372216],
  p1 = [1.600000, 0, 0.200000]
}
#0.1.5 {
  a = [0.000000, 0.000000, 0.000000],
  aTemp = [0.000000, 0.000000, 0.000000],
  ballp = [1.295919, 0.259184, 0.405979],
  ballv = [3.500000, 0.500000, 2.000000],
  batAngle = [0.007323, 0.000000, 0.000000],
  batAngle' = [-0.007397, 0.000000, 0.000000],
  batp = [-1.600000, -0.000000, 0.200000],
  bounced = false,
  className = Player,
  count = 0,
  ...
  t' = 1,
  v = [0.000000, 0.000000, 0.000000],
  v2 = [1.981408, 0.128395, 4.361122],
  v21 = [-1.490704, 0.185803, -0.930561],
  z = -9.763445
}
#0.1.6 {
  a = [-0.000000, 50.980439, 32.435818],
  aTemp = [-248.817183, 50.980439, 81.089544],
  ballp = [1.295919, 0.259184, 0.405979],
  ballv = [3.500000, 0.500000, 2.000000],
  batAngle = [0.010000, 0, 0],
  batAngle' = [-0.175747, 0.020551, 0.248989],
  batp = [1.600000, 0.000000, 0.200000],
  bounced = true,
  className = Player,
  count = 0,
  desiredBatP = [-1.004510, 0.919098, 0.317820],
  desiredBatP' = [-9.122435, 7.775513, 6.179371],
  estimatedBatV = [0.000000, 7.898737, 0.719227],
  estimatedBatV' = [-0.000000, 50.980439, 32.435818],
  hit = false,
  mode = "Prepare",
  n = 2,
  n1 = 2.859923,
  ...
  t = 40.000000,
  t' = 1,
  v = [-9.122435, 7.775513, 6.179371],
  v2 = [-2.290941, 0.384820, 4.162431],
  v21 = [1.645470, -0.192410, -2.331215],
  z = -0.685169
}
#0.1.7 {
  ...
  n = 1,
  p = [-1.600000, -0.000000, 0.200000],
  p' = [-5.000000, 0.500000, 12.263445],
  p1 = [-1.600000, 0, 0.200000]
}
#0.1.8 {
  _3D = ["Box", [1.550000, 0.000000, 0.200000], [0.300000, 0.300000, 0.300000], [1, 1, 0.100000], [-0.000000, 1.279758, -1.464373]],
  angle = [0.010000, 0, 0],
  className = Bat,
  displayAngle = [0.000000, -1.279758, 1.464373],
  mode = "Rest",
  n = 2,
  p = [1.600000, 0.000000, 0.200000],
  p' = [0, 0, 0],
