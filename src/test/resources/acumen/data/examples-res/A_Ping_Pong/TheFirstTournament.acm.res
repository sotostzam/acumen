...
#0.1.0 {
  ...
  batAngle = [0.002735, 0.000000, 0.000000],
  batAngle' = [-0.002763, 0.000000, 0.000000],
  batp = [-1.600000, 0.000000, 0.200000],
  bounced = false,
  className = Virtue,
  count = 0,
...
#0.1.1 {
  ballp = [3.030594, 0.606119, 0.032702],
  ballv = [0.000000, 0.000000, 0.000000],
  batAngle = [0.928620, 0.160380, -0.287100],
  batAngle' = [-0.938000, -0.162000, 0.290000],
  batp = [1.600000, 0.000000, 0.200000],
  bounced = false,
  className = ParadoX,
  count = 0,
...
#0.1.4 {
  action = 0,
  angle = [-0.938000, -0.162000, -0.290000],
  className = BallActuator,
  done = false,
  mode = "Initialize",
  v1 = [-2.338273, -0.355691, 1.671503],
  v2 = [3.900151, 0.721735, 3.600227],
  v3 = [0.600000, 4.450000, 0.950000]
}
#0.1.5 {
  angle = [0.002763, 0.000000, 0.000000],
  className = BatActuator,
  energy = 13.794667,
  energy' = 0.000000,
  p = [-1.600000, 0.000000, 0.200000],
...
#0.1.6 {
  angle = [0.928620, 0.160380, -0.287100],
  className = BatActuator,
  energy = 18.002772,
  energy' = 0.000000,
  p = [1.600000, 0.000000, 0.200000],
...
#0.1.8 {
  _3D = ["Box", [1.550000, 0.000000, 0.200000], [0.300000, 0.300000, 0.300000], [1, 1, 0.100000], [-0.000000, 0.457550, -1.825597]],
  angle = [0.928620, 0.160380, -0.287100],
  className = Bat,
  displayAngle = [0.000000, -0.457550, 1.825597],
  mode = "Rest",
  n = 2,
  p = [1.600000, 0.000000, 0.200000],
  p' = [0, 0, 0],
