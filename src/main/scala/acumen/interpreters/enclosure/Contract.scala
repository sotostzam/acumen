...
trait Contract {
  ...
  def backPropagate(env: Box, ran: Interval, expr: Expression): Box = expr match {
    ...
    case Cbrt(e)   => throw new NotImplementedError("Contract.backPropagate.cbrt")
    case Exp(e)    => backPropagate(env, e(env) \/ ran.log, e)
    case Log(e)    => backPropagate(env, e(env) \/ ran.exp, e)
    case Log10(e)  => throw new NotImplementedError("Contract.backPropagate.log10")
    case Sin(e)    => backPropagate(env, e(env) \/ ran.asin, e)
    case Cos(e)    => backPropagate(env, e(env) \/ ran.acos, e)
    case Tan(e)    => backPropagate(env, e(env) \/ ran.atan, e)
    case ASin(e)   => backPropagate(env, e(env) \/ ran.sin, e)
    case ACos(e)   => backPropagate(env, e(env) \/ ran.cos, e)
    case ATan(e)   => backPropagate(env, e(env) \/ ran.tan, e)
    case Sinh(e)   => throw new NotImplementedError("Contract.backPropagate.sinh")
    case Cosh(e)   => throw new NotImplementedError("Contract.backPropagate.cosh")
    case Tanh(e)   => throw new NotImplementedError("Contract.backPropagate.tanh")
    case Plus(l, r) =>
      val lenv = l(env)
      val renv = r(env)
