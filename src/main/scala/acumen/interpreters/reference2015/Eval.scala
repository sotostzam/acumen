...
case class CollectedAction(o: CId, d: DIndex, rhs: Expr, env: Env)
...
object Eval {
  ...
  def logAssign(o: CId, d: DIndex, r: Expr, e: Env) : Eval[Unit] =
    mkEval(s => ((), Changeset(das = List(CollectedAction(o,d,r,e))), s))

  def logEquation(o: CId, d: DIndex, r: Expr, e: Env) : Eval[Unit] =
    mkEval(s => ((), Changeset(eqs = List(CollectedAction(o,d,r,e))), s))

  def logODE(o: CId, d: DIndex, r: Expr, e: Env) : Eval[Unit] =
