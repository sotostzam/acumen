...
class App extends SimpleSwingApplication {
  ...
  private val floatingPointStandardAction     = mkActionMask("Traditional Functional",              VK_F, VK_R,       shortcutMask | SHIFT_MASK, setInterpreter("reference"))
  private val floatingPointOriginalAction     = mkActionMask("Traditional Functional Original",     VK_O, NONE,       shortcutMask | SHIFT_MASK, setInterpreter("original"))
  private val floatingPointExperimentalAction = mkActionMask("Traditional Functional Experimental", VK_E, NONE,       shortcutMask | SHIFT_MASK, setInterpreter("experimental"))
