...
public class TexturePack {
     ...
     *            {@link java.awt.image.BufferedImage} class
     ...
     * see {@link com.threed.jpct.FrameBuffer#blit(com.threed.jpct.Texture, int, int, int, int, int, int, int, int, int, boolean, java.awt.Color)
     ...
     *         array instance
     * @see com.threed.jpct.FrameBuffer#blit(com.threed.jpct.Texture, int, int, int, int, int, int, int, int, int, boolean, java.awt.Color)
     *      FrameBuffer.blit(..)
     */
     ...
     * @return size of blitted image. note this method always returns the same
     *         array instance
     * @see com.threed.jpct.FrameBuffer#blit(com.threed.jpct.Texture, int, int, int, int, int, int, boolean)
     *      FrameBuffer.blit(..)
     */
