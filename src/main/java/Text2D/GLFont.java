...
public class GLFont {
    ...
    /** All the characters */
    public static final String Characters = ENGLISH + GERMAN + FRENCH + TURKISH;
    /**
     * same as getGLFont(font, ENGLISH)
     * @see #getGLFont(java.awt.Font, String)
     * */
    public static GLFont getGLFont(Font font) {
        return getGLFont(font, Characters);
    }
     ...
     * see {@link java.awt.FontMetrics} for a discussion */
